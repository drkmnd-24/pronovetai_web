...
/* -------------------------------------------------- */
const optionsEurope    = { ...tinyAreaOptions, colors: ["#5350e9"], series: [{ data: [310,800,600,430,540,340,605,805,430,540,340,605] }] };
const optionsAmerica   = { ...tinyAreaOptions, colors: ["#008b75"], series: [{ data: [410,700,500,330,640,440,705,605,330,640,440,705] }] };
const optionsIndonesia = { ...tinyAreaOptions, colors: ["#dc3545"], series: [{ data: [510,900,700,530,740,540,805,905,530,740,540,805] }] };
...
(function updateODFormChart() {
  ...
  .then(data => {
    ...
    data.results.forEach(o => { if (counts[o.status] !== undefined) counts[o.status]++; });
